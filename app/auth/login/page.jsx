...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      {/* Header - Same as About Us & SignUp */}
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-8 sm:p-12">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() =>
                      setLoginForm((prev) => ({ ...prev, role: "applicant" }))
                    }
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setLoginForm((prev) => ({ ...prev, role: "company" }))
                    }
                    className={`relative overflow-hidden rounded-xl p-4 border transition-all duration-300 ${
              ...
              <button
                ...
                className={`w-full rounded-full px-6 py-3.5 font-semibold text-white shadow-lg transition ${
                  loginForm.role === "company"
